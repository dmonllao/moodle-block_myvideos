...
$string['author'] = 'Autor';
$string['author_help'] = 'L\'autor del video';
...
$string['comments_help'] = 'Permet afegir comentaris a altres usuaris';
$string['download'] = 'Descarrega';
$string['embedded'] = 'Codi incrustat del video';
$string['embedded_help'] = 'Engantxa aquí el codi HTML del video';
$string['errorcant'] = 'No, no podem';
$string['errorcantdelete'] = 'No es pot eliminar';
$string['errorcantsave'] = 'No es pot guardar';
$string['errorcheckpermissions'] = 'Comprova els permissos de la variable de configuració path o canvia la configuració del bloc';
...
$string['keywords_help'] = 'Etiquetes del video, facilita les cerques';
$string['loading'] = 'Carregant';
$string['myvideos:addinstance'] = 'Afegir un bloc dels Meus videos';
...
$string['pluginname'] = 'Els meus videos';
$string['publiclevel'] = 'Privacitat';
$string['publiclevel_help'] = '<ul><li>Video privat: Els altres usuaris no poden veure ni buscar el video</li>
<li>Només a Moodle: El video es pot buscar i ser vist per altres usuaris de Moodle</li>
<li>Video públic: El video és accessible per tots els usuaris de la www</li>
</ul>';
$string['quality'] = 'Qualitat';
$string['quality_help'] = 'Et permet seleccionar la qualitat de la codificació, a més qualitat més frames per segon';
