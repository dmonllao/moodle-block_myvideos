...
$string['settingffmpeg'] = 'Path to ffmpeg'; 
$string['settingffmpegdesc'] = 'Path to the ffmpeg conversion program. ffmpeg is allowed even though it is deprecated. avconv is recommended instead.';
$string['settingmencoder'] = 'Path to mencoder'; 
